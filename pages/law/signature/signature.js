Page({
  ...
  uploadScaleStart(e) {
    ...
    this.data.currentPoint = currentPoint
  ...
  uploadScaleMove(e) {
    ...
    this.data.lastPoint = this.data.currentPoint
  ...
  uploadScaleEnd(e) {
    ...
    this.data.chirography = chirography
    var linePrack = this.data.linePrack
    linePrack.unshift(this.data.currentLine);
    this.data.linePrack = linePrack
  ...
  setCanvasBg() {
    ...
    this.data.ctx.fillStyle = 'rgba(255, 255, 255, 0)' // 透明背景
    this.data.ctx.fillRect(0, 0, this.data.canvasWidth, this.data.canvasHeight)
  ...
  onLoad(options) {
    ...
    .exec((res) => {
      ...
      //this.data.ctx.globalAlpha = this.data.transparent // 设置半透明
      ...
      this.data.canvasWidth = canvas.width
      this.data.canvasHeight = canvas.height

      this.setCanvasBg();
    })
    // 旧接口
    // this.data.ctx = wx.createCanvasContext(this.data.canvasName)
    // wx.createSelectorQuery().select('.handCenter').boundingClientRect(rect => {
    //   this.data.canvasWidth = rect.width
    //   this.data.canvasHeight = rect.height
